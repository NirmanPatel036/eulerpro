...
export default function StudentProfilePage() {
    ...
    const handleCropComplete = async (croppedImageBlob: Blob) => {
        ...
        const { error: uploadError } = await supabase.storage
            .from('profiles')
            .upload(path, croppedImageBlob, { upsert: true, contentType: 'image/jpeg' });
                        ...
                        <div className="bg-amber-50 border border-amber-100 rounded-2xl px-5 py-4 space-y-3">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-xs text-amber-600 mt-0.5">{completedCount} of {completionSteps.length} steps done</p>
                                </div>
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="relative shrink-0">
                            <button
                                ...
                                className="relative w-20 h-20 rounded-2xl overflow-hidden group focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-500"
                            >
                                {profile?.avatar_url ? (
                                    <img
                                    ...
                                    <div
                                        ...
                                        style={{ background: 'linear-gradient(135deg, #4b3fe9, #7c3aed)' }}
                                    >
                                        {initials}
                                    </div>
                                )}
                            ...
                            {editingName ? (
                                <div className="flex items-center gap-2">
                                    <input
                                        ...
                                        className="text-sm font-semibold text-gray-900 bg-gray-50 border border-gray-200 rounded-lg px-2 py-1 outline-none focus:border-violet-400 w-full max-w-xs"
                                        maxLength={80}
                                    />
                                    <button
                                        ...
                                        className="w-7 h-7 rounded-lg bg-violet-500 hover:bg-violet-600 flex items-center justify-center transition-colors shrink-0"
                                    >
                                        {savingName
